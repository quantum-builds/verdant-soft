...
export default function FeatureCard({ title, link, image }: IFeatures) {
  ...
  return (
    <div className="relative w-[280px] h-[240px] sm:w-[300px] sm:h-[260px] md:w-[320px] md:h-[280px] lg:w-[170px] lg:h-[150px] xl:w-[190px] xl:h-[160px]  2xl:w-[230px] 2xl:h-[190px] 3xl:w-[250px] 3xl:h-[210px]   4xl:w-[260px] 4xl:h-[220px]  5xl:w-[320px] 5xl:h-[280px] font-inter text-white overflow-hidden group rounded-3xl">
      ...
      <div className="absolute inset-0 z-10 p-4 lg:p-2 4xl:p-4 flex flex-col justify-between">
        <div>
          ...
          >
            <Link
              href={link}
              className="text-sm sm:text-base rounded-xl border-0 lg:border lg:border-white px-3 py-4 bg-green-gradient lg:bg-white/10 lg:hover:bg-white/20 w-fit lg:hover:bg-green-gradient hover:border-0 transition duration-800 ease-in-out"
            >
              Explore More
            </Link>
          </div>
