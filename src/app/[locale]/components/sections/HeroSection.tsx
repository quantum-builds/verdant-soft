  ...
  return (
    <div className="relative min-h-[70vh] md:min-h-screen flex flex-col space-y-6 overflow-hidden bg-white mb-28">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center gap-5 mt-20 md:mt-24 xl:mt-28 mx-6 lg:mx-10 xl:mx-14 mb-5 bg-gray rounded-3xl">
        <motion.p
          className="text-2xl md:text-3xl xl:text-6xl font-bold leading-tight font-inter w-1/2 2xl:w-1/2 mx-auto text-center"
          initial="hidden"
          whileInView="visible"
        ...
        <motion.p
          className="text-md xl:text-xl leading-tight w-2/3 lg:w-1/2 xl:w-1/3 mx-auto text-center"
          initial="hidden"
          whileInView="visible"
        ...
        <motion.div
          className="flex justify-between w-1/2 lg:w-[40%] xl:w-1/5"
          initial="hidden"
          whileInView="visible"
