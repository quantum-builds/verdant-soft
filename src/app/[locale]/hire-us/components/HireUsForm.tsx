      ...
      <div className="flex  items-center justify-between mt-24 md:mt-32 xl:mt-40  w-11/12 mx-auto gap-10">
        <div className="flex-1 flex flex-col justify-between h-full  ">
          <div className="flex flex-col gap-6 w-3/5 mx-auto">
            <p className="text-3xl font-semibold">Team Outsourcing</p>
            <h2 className="text-7xl text-green-gradient font-semibold">
              Hire an Expert
            </h2>
            <p className="text-[#666666]">
              Partner with us for seamless team outsourcing, ensuring expert
              support and flexible solutions.Enhance your business efficiency by
              leveraging our dedicated teams tailored to your needs.
            </p>
          </div>
          <Image
            src={DottedBG}
