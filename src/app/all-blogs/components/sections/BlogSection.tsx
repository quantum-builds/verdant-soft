  ...
  return (
    <section className="relative flex flex-col space-y-6 overflow-hidden bg-white mb-28 ">
      ...
      <div className="min-h-[30vh] mt-24 md:mt-30 xl:mt-36  w-11/12 xl:w-10/12  mx-auto flex flex-col gap-12 xl:gap-16 overflow-hidden">
        ...
        <motion.div
          className="flex-1 overflow-hidden lg:flex lg:flex-row lg:overflow-x-auto lg:scroll-smooth lg:scrollbar-hide cursor-pointer grid gap-4 md:grid-cols-2 xl:gap-8 md:auto-rows-auto"
          initial="hidden"
          whileInView="visible"
