                ...
                <div className="flex flex-col gap-16 lg:gap-24 p-4 md:p-12  w-full lg:w-11/12 mx-auto">
                  <div className="flex flex-col  justify-center gap-12 lg:gap-16">
                    ...
                    <h1 className="font-bold text-3xl xl:text-[40px]  text-green-gradient">
                      Psychiatric Clinic and Hospital Management System
                    </h1>
                    <p className="text-lg lg:text-xl">
                      We developed a comprehensive healthcare management system
                      ...
                      <span className="font-semibold">
                        medications, allergies, visits, and lab orders modules
                      </span>
                    </p>
                  </div>
