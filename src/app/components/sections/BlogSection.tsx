          ...
          {BLOGS.map((blog, index) => (
            ...
            >
              <Image
                src={blog.imageUrl}
                alt={`blog-${index}`}
                className=" w-full rounded-2xl h-[260px] lg:h-[250px] xl:h-[290px] opacity-50 group-hover:opacity-100 group-hover:grayscale-0 grayscale-100 transition-all duration-300 ease-in-out"
              />
