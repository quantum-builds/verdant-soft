  ...
  return (
    <section id="blogs" className="scroll-mt-28">
      <div className="min-h-[70vh] 3xl:min-h-[50vh] w-11/12 xl:w-10/12  mx-auto mb-28 flex flex-col gap-12 overflow-hidden">
        ...
        <motion.div
          className="flex-1 lg:flex overflow-hidden lg:flex-row  lg:scroll-smooth lg:scrollbar-hide cursor-pointer grid gap-4 md:grid-cols-2 xl:gap-8 md:auto-rows-auto"
          initial="hidden"
          whileInView="visible"
