...
export default function TechnologiesSection({
  ...
  return (
    <section
      id="technologies"
      className="scroll-mt-36 min-h-[580px] md:min-h-[630px] lg:min-h-[590px] xl:min-h-[705px] 2xl:min-h-[600px]  4xl:min-h-[610px] 5xl:min-h-[650px] w-11/12 xl:w-10/12 mx-auto flex flex-col gap-10 xl:gap-20 mb-20 overflow-hidden text-black"
    >
      <p
        className="w-11/12 md:w-3/4 lg:w-2/3 xl:w-3/5 2xl:w-8/12 text-2xl md:text-3xl lg:text-4xl xl:text-5xl 3xl:text-[54px] 4xl:text-6xl 5xl:text-7xl font-semibold text-footer-black leading-tight"
