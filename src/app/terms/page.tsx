  ...
  return (
    <>
      <main className="relative min-h-[110vh] flex flex-col mb-28 overflow-hidden mx-auto">
        <Navbar />
        <div className="bg-green-gradient flex flex-col text-center justify-center md:mt-22 xl:mt-30">
          <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold mb-6 text-white inline-block leading-tight">
            Terms & Conditions
          </h1>
          <p className="mb-8 text-lg lg:text-xl text-center text-white w-11/12 md:w-10/12 lg:w-8/12 xl:w-1/2 mx-auto">
        ...
        <div className=" w-11/12 xl:w-10/12 mx-auto">
          <section className="max-w-11/12 lg:max-w-10/12 xl:max-w-8/12  p-6 text-gray-800 mt-16  ">
